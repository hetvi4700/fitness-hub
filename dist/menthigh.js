var images = [
    { src: "../img/../img/skipping.gif", alt: "Image 2", title: "Title 2", description: "Skipping exercise" },
    { src: "../img/split jump exercise.gif", alt: "Image 3", title: "Title 3", description: "Split jump exercise" },
    { src: "../img/Aerobic.gif", alt: "Image 1", title: "Title 1", description: "Aerobic exercise" }
