var images = [
    { src: "../img/jumping lunges.gif", alt: "Image 1", title: "Title 1", description: "Jumping lunges exercise" },
    { src: "../img/Bulgarian Split Squat Jump.gif", alt: "Image 2", title: "Title 2", description: "Bulgarian split squat jump exercise " },
    { src: "../img/debug2.gif", alt: "Image 3", title: "Title 3", description: "Deadbug exercise " }
