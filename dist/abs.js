var images = [
    { src: "../img/debug2.gif", alt: "Image 1", title: "Title 1", description: "deadbug exercise" },
    { src: "../img/leg raise.gif", alt: "Image 2", title: "Title 2", description: "leg raise exercise " },
    { src: "../img/spiderman pushups.gif", alt: "Image 3", title: "Title 3", description: "Spiderman pushup exercise " },
    { src: "../img/cobra2.gif", alt: "Image 3", title: "Title 3", description: "cobra exercise " }
  ];
