var images = [
    { src: "../img/plank low to high.gif", alt: "Image 1", title: "Title 1", description: "plank low to high" },
    { src: "../img/Russian twist.gif", alt: "Image 2", title: "Title 2", description: "Russian twist" },
    { src: "../img/elbow to knee crunch.gif", alt: "Image 3", title: "Title 3", description: "elbow to knee crunch " },
    { src: "../img/skipping.gif", alt: "Image 4", title: "Title 3", description: "Skipping exercise " }
