var images = [
    ...
    { src: "../img/spiderman pushups.gif", alt: "Image 3", title: "Title 3", description: "Spiderman pushups exercise " },
    { src: "../img/cobra.gif", alt: "Image 4", title: "Title 3", description: "Cobra exercise " }
