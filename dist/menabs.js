var images = [
    { src: "../img/T plank.gif", alt: "Image 2", title: "Title 2", description: "T plank" },
    { src: "../img/elbow to knee crunch.gif", alt: "Image 3", title: "Title 3", description: "elbow to knee crunches" },
    { src: "../img/Russian twist.gif", alt: "Image 1", title: "Title 1", description: "Russian twist" }
